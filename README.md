...
A modern web browsere.g. Google Chrome
Node.js with npm
...
Go to https://github.com/giuliadant/Web-Development and download project as a ZIP file:
Code → Download ZIP

2. Extract the ZIP
Extract the downloaded ZIP file. This will create a folder called Web-Development-main.

3. Navigate to the project folder
Open a terminal and navigate into the extracted folder:
bashcd path/to/Web-Development-main

Replace path/to/ with the actual path where you extracted the folder.
...
The Endless Quest loading screen will appear and the game is ready to play. 
